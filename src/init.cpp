...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizekonjungateamount=<n> " + _("Keep N Konjungate anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeKonjungateAmount = GetArg("-anonymizekonjungateamount", 0);
    if(nAnonymizeKonjungateAmount > 999999) nAnonymizeKonjungateAmount = 999999;
    if(nAnonymizeKonjungateAmount < 2) nAnonymizeKonjungateAmount = 2;
    ...
    LogPrintf("Anonymize Konjungate Amount %d\n", nAnonymizeKonjungateAmount);
