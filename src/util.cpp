...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Konjungate
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Konjungate
    // Mac: ~/Library/Application Support/Konjungate
    // Unix: ~/.Konjungate
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Konjungate";
#else
    fs::path pathRet;
